  ...
  return (
    <header className="sticky top-0 z-50 px-2 pt-2 sm:px-3 sm:pt-3 md:px-5 md:pt-4 xl:px-6 xl:pt-5">
      <div className="luxury-shell">
        <div className="flex items-center justify-between gap-1.5 rounded-[18px] border border-white/80 bg-white/95 px-2.5 py-2 shadow-[0_4px_20px_rgba(15,23,42,0.06)] sm:gap-2 sm:rounded-[22px] sm:px-3 sm:py-2.5 md:gap-3 md:rounded-[26px] md:px-4 md:py-2.5 lg:gap-4 lg:px-5 lg:py-3 xl:rounded-[28px]">
          <Link href={`/${locale}`} className="flex min-w-0 items-center gap-1.5 sm:gap-2 md:gap-2.5 lg:gap-3">
            <div className="relative h-8 w-8 shrink-0 overflow-hidden rounded-full sm:h-9 sm:w-9 lg:h-10 lg:w-10">
              <Image
                src="/logo.png"
        ...
        {isMenuOpen ? (
          <>
            ...
            <div className="absolute inset-x-0 top-full z-50 mt-3 lg:hidden">
              <div className="overflow-hidden rounded-[28px] border border-white/80 bg-white p-4 shadow-[0_8px_32px_rgba(15,23,42,0.12)]">
