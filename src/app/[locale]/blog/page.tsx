      ...
      <section className="luxury-shell py-12 md:py-14 xl:py-16">
        <ScrollReveal className="grid gap-5 sm:grid-cols-2 xl:grid-cols-3 2xl:gap-6">
          ...
          {blogs.map((post, index) => (
            <ScrollReveal key={post.slug} direction="up" delay={Math.min(index * 80, 400)} className="flex">
              <article className="luxury-card luxury-border group flex h-full flex-col overflow-hidden p-5 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_12px_40px_rgba(15,23,42,0.08)] hover:border-amber-200/60 xl:p-6">
                ...
                <div className="mt-6 flex items-center justify-between rounded-2xl bg-zinc-950 px-4 py-3 text-sm text-white/80 shadow-sm">
